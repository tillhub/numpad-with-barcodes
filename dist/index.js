...
var NumPad = function (_Component) {
  ...
  function NumPad() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn$1(this, (_ref2 = NumPad.__proto__ || Object.getPrototypeOf(NumPad)).call.apply(_ref2, [this].concat(args))), _this), _this.state = {
...
var Search$1 = withStyles(styles)(SearchProduct);
