...
| text                  | object   | no       | See Product text options                                       | See Product text options | Object of text fields to to desplay as field titles                                                                                                                                        |
    ...
    return (
      <div>
        <NumPad
          ...
          pickedQty={this.state.qty || '0'} // default to '0' if you never want to show an empty input field
        />
...
### Product text options and defaults.
